    ...
    <div class="text-center">
      ...
      <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-5">
            <input type="radio" name="Product"value="TV" required>TV <tr>
            <input type="radio" name="Product"value="Kulkas" required>Kulkas <tr>
            <input type="radio" name="Product"value="mesin cuci" required>Mesin Cuci <tr>
          </div>
        </div>
        <br>
